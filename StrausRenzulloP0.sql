...
ALTER TABLE BANK_TRANSACTION
  ADD CONSTRAINT FK_BANKUSER_TRANSACTION
FOREIGN KEY (BANKUSER_ID) REFERENCES BANK_USER(USER_ID)
ON DELETE CASCADE;
/
...
VALUES ('GOD', -1146911805, 1);
/
INSERT ALL
INTO BANK_USER(USERNAME, PASSWORD)
VALUES ('James', -1146911805)
INTO BANK_USER(USERNAME, PASSWORD)
VALUES ('Emily', -1146911805)
SELECT * FROM DUAL;